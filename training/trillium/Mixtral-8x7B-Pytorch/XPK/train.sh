...
--overwrite_output_dir --config_name=/workspace/tpu-recipes/training/trillium/Mixtral-8x7B-Pytorch/XPK/config.json \
...
--fsdp_config=/workspace/tpu-recipes/training/trillium/Mixtral-8x7B-Pytorch/XPK/fsdp_config.json --torch_dtype=bfloat16 \
